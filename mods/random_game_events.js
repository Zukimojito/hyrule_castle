...
exports.KnowIfEnnemisOrBoss = exports.RandomRoom = void 0;
...
var traps = require('./jsonObjectGame/traps.json');
function RandomRoom(_player, _coins, OriPlayer) {
    var choice;
    var coin;
    var HPLost;
    ...
    if (choice === 1) {
        ...
        if (random1 > 50) {
            ...
            if (random2 === traps[0].rarity) {
                if (_player.str >= 10) {
                    coin = _coins + 1;
                    console.log("You meet the requirements and gain 1 coin in trap room because you str is ".concat(_player.str));
                    return coin;
                }
                if (_player.str < 10) {
                    ...
                    console.log("You lost ".concat(HPLost, " HP"));
                    _player.hp -= HPLost;
                    return _coins;
                }
            }
                ...
                if (_player.int >= 10) {
                    coin = _coins + 1;
                    console.log("You meet the requirements and gain 1 coin in trap room because you int is ".concat(_player.int));
                    return coin;
                }
                if (_player.int < 10) {
                    console.log("You don't meets the requirements");
        ...
        if (random1 <= 50) {
            ...
            _coins += coin;
            console.log('\x1b[36m%s\x1b[0m', "You gains ".concat(coin, " coins !"));
            return _coins;
        }
    }
    if (choice === 2) {
...
function KnowIfEnnemisOrBoss(i, _player, _coins, OriPlayer) {
    var roomOrNot = Math.floor(Math.random() * 100) + 1;
    if (i % 10 !== 0) {
        if (roomOrNot <= 35) {
...
exports.KnowIfEnnemisOrBoss = KnowIfEnnemisOrBoss;
